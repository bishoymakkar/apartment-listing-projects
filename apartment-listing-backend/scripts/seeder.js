...
var apartment_1 = require("../src/models/apartment");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, apartment_1.default.insertMany(apartmentsData)];
                case 1:
                    _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error seeding apartments:', error_1);
                    return [3 /*break*/, 4];
                case 3:
                    (0, db_1.disconnectFromDatabase)();
                    return [7 /*endfinally*/];
